 ...
 */
class Customweb_Unzer_Communication_Operation_Recurring_ResponseProcessor extends Customweb_Unzer_Communication_AbstractTransactionProcessor {
	public function process(Customweb_Core_Http_IResponse $response){
		try {
			...
			$this->getLogger()->logException($e, $response);
		}
